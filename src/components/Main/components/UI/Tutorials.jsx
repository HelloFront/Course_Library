...
import imgTutorial from '../Home/img/icon_tutorial.jpg';
    ...
    return(
      <div className="wrapper">
        <div className="tutorials_block">
          ...
          <div className="out_tutorial">
            <div className="left_column">
              <div className="item_tutorial">
                ...
                <div className="description_tutorial">
                  ...
                  <button className='view'>Посмотреть</button>
                </div>
              </div>
            ...
            <aside>
              <div className="item">
                <div className="img_card">
                  <img src={imgTutorial} alt="icon_pc"/>
                </div>
                <p className="name_card">Learning React Native</p>
              </div>
